...
|---------------------|---------------|----------|
| Broad Intake (9-bucket scan) | explore | `/start-project`, `/backlog-add` |
...
|---------|-----------------|-------|
| `/start-project` | Broad Intake Review (9-bucket scan) → Task(explore) | Phase 2 |
| `/backlog-add` | Broad Intake Review (same 9 buckets) → Task(explore) | Phase 2 |
