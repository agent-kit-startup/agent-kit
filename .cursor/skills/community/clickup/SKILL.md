...
**Not part of the Core Pack.** Install/use only when the repository integrates ClickUp. Aligned with rule [cursor-skills-clickup.mdc](../../../rules/cursor-skills-clickup.mdc) (`alwaysApply: false`).
