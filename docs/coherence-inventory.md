...
| `.cursor/hooks.json` | core | ⏳ still missing — Cursor native hooks design deferred (not blocking distribution) |
...
| File | Class | Action |
|------|-------|--------|
| `git-autogit.md` | core | ✅ staging spine + HITL prod |
| `docs-repo.md` | core | ✅ docs-standard |
| `cleancode-refactor.md` | core | ✅ links clean-code skill |
| `security-reviewer.md` | core | ✅ keep |
| `context-librarian.md` | core | ✅ handoff / context pack |
| `memory-extractor.md` | core | ✅ memory-loop |
| `tech-lead.md` | core | ✅ ADR / tradeoffs |
| `json-guardian.md` | stack | ✅ on demand |
| `prompts-agents.md` | stack | ✅ on demand |
| `n8n-workflows.md` | stack | ✅ on demand |
| `sql-schema.md` | stack | ✅ on demand |
| `clickup-tasks.md` | stack | ✅ path → community/clickup |
| `testes-roteiros.md` | stack | ✅ project QA routines |
...
| File | Class | Action |
|------|-------|--------|
| `iniciar-projeto.md` | core | ✅ keep |
| `continuar-plano.md` | core | ✅ keep |
| `executar-plano-loop.md` | core | ✅ L0; no prod |
| `executar-plano-orquestrado.md` | core | ✅ L0; no prod |
| `handoff.md` | core | ✅ keep |
| `resumo.md` | core | ✅ keep |
| `context-status.md` | core | ✅ keep (not L0 install list — project-local OK) |
| `git-staging.md` | core | ✅ L0 |
| `git-homolog.md` | core | ✅ L0 legacy alias |
| `git-prod.md` | core | ✅ HITL confirmation |
| `dicas.md` | core | ✅ optional UX |
...
1. **`.cursor/hooks.json`** — design Cursor-native hooks when IDE surface is prioritized.
