...
| Staging vs homolog | `git-prod` almost universal; `git-staging` only in a minority; many still on `git-homolog` only |
...
| `continuar-plano.md`, `handoff.md`, `iniciar-projeto.md`, `resumo.md`, `context-status.md` | 12/13 | L0 commands |
| `git-prod.md` | 13/13 | L0 |
| `git-staging.md` | 5/13 | L0 (canonical; migrate homolog) |
| `git-homolog.md` | 9/13 | L0 legacy alias |
...
| `/executar-plano-loop` | Registry-based installations | L0 — shipped with orchestration commands |
...
| `/executar-plano-loop` | Registry installations | Promoted to L0 — available via core pack |
