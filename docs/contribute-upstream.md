...
- You created an Agent Persona that belongs in `registry/personas/community/`.
...
| `.cursor/personas/<id>/persona.json` | `registry/personas/community/<id>/persona.json` (community personas only) |
